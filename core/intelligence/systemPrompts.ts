...
import { INTEGRATION_ARCHITECT } from './agents/integrationArchitect';
import { OBSERVABILITY_ENGINEER } from './agents/observabilityEngineer';
import { PERFORMANCE_ARCHITECT } from './agents/performanceArchitect';
import { COMPLIANCE_ENGINEER } from './agents/complianceEngineer';
...
export const SYSTEM_PROMPTS = {
    ...
    STRATEGY_AGENT: STRATEGY_AGENT.systemPrompt,
    ...
    INTEGRATION_ARCHITECT: INTEGRATION_ARCHITECT.systemPrompt,

    ACCESSIBILITY_ENGINEER: ACCESSIBILITY_ENGINEER.systemPrompt,
    ...
    PERFORMANCE_ARCHITECT: PERFORMANCE_ARCHITECT.systemPrompt,
    ...
    COMPLIANCE_ENGINEER: COMPLIANCE_ENGINEER.systemPrompt,
    ...
    OBSERVABILITY_ENGINEER: OBSERVABILITY_ENGINEER.systemPrompt,

    SRE: SRE_AGENT.systemPrompt,
